        ...
        <div class="row align-items-center"
            ...
            <div class="col-lg-7 text-white">
                ...
                <p class="lead mb-4">
                    ...
                    Bergabunglah bersama PKBM ANIK untuk memperoleh pendidikan kesetaraan yang berkualitas, fleksibel, dan sesuai kebutuhan masyarakat.
...
@php
    ...
    $persyaratan = array_filter($persyaratan, fn($item) => trim($item) != '');
@endphp
                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow border-0 h-100">
                        <div class="card-body text-center">
                            ...
                            <div class="bg-primary text-white rounded-circle mx-auto mb-3 d-flex justify-content-center align-items-center"
...
@php
    $jadwal = preg_split('/\r\n|\r|\n/', trim($ppdb->jadwal));
    $jadwal = array_filter($jadwal, fn($item) => trim($item) != '');
@endphp
...
<section class="py-5">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="text-muted">
                Berikut tahapan penting selama proses penerimaan peserta didik baru.
            </p>
        </div>
        ...
        <div class="timeline">
            @foreach($jadwal as $item)
                ...
                @php
                    ...
                    $tanggal = trim($bagian[0] ?? '');

                    $kegiatan = trim($bagian[1] ?? '');
                @endphp
